...
const informacionRoutes_1 = __importDefault(require("./routes/informacionRoutes"));
class Server {
    constructor() {
    ...
    routes() {
        ...
        this.app.use('/api/info', informacionRoutes_1.default);
    }
    start() {
        this.app.listen(this.app.get('port'), () => {
            console.log('Servidor ejecutandose en', this.app.get('port'));
        });
    }
}
